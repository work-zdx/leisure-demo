...
class GameSingleActivity: BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        iv_game_single.setOnClickListener {
            StarMedia.openStarGame(this, "{\"game_id\":10005, \"menu\":false}") {
                if (!it) {
                    Toast.makeText(this, "开发游戏失败", Toast.LENGTH_LONG).show()
                }
            }
        ...
        rv_game_group.layoutManager = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)
        rv_game_group.adapter = gameAdapter
    }
